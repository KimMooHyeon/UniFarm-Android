...
class CollectViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RecommenddataList.add(RecommendCollectViewData("hello","충북 보은 마을재생","#충북","41","50"))
        RecommenddataList.add(RecommendCollectViewData("hello","충남 보은 마을재생","#충남","43","50"))
        RecommenddataList.add(RecommendCollectViewData("hello","경북 보은 마을재생","#경북","45","50"))
        RecommenddataList.add(RecommendCollectViewData("hello","충북 보은 마을재생","#충북","41","50"))
        RecommenddataList.add(RecommendCollectViewData("hello","충남 보은 마을재생","#충남","43","50"))
        RecommenddataList.add(RecommendCollectViewData("hello","경북 보은 마을재생","#경북","45","50"))
        RecommenddataList.add(RecommendCollectViewData("hello","충북 보은 마을재생","#충북","41","50"))
        ...
        CollectdataList.add(CollectPopularProgramData("hello","인천광역시","공부하기"))
        CollectdataList.add(CollectPopularProgramData("hello","부산광역시","놀기"))
        CollectdataList.add(CollectPopularProgramData("hello","서울특별시","취업하기"))
        CollectdataList.add(CollectPopularProgramData("hello","인천광역시","공부하기"))
        CollectdataList.add(CollectPopularProgramData("hello","부산광역시","놀기"))
        CollectdataList.add(CollectPopularProgramData("hello","서울특별시","취업하기"))
        CollectdataList.add(CollectPopularProgramData("hello","인천광역시","공부하기"))
